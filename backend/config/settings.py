...
# ============================================
# Chinese API Configuration - RESTORED 2025
# ============================================
...
API_BASE_URL = os.getenv('API_BASE_URL', 'https://pimpmycase-webstore.onrender.com')  # API base URL for generating secure URLs

# Image Processing Configuration
MAX_IMAGE_DIMENSION = 1024
DEFAULT_IMAGE_SIZE = "1024x1536"  # Portrait orientation for phone cases
