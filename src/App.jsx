...
import BrandModelSelectionScreen from './screens/BrandModelSelectionScreen'
import CustomizeImageScreen from './screens/CustomizeImageScreen'
import BrowseDesignsScreen from './screens/BrowseDesignsScreen'
import DesignPreviewScreen from './screens/DesignPreviewScreen'
import AddStickersScreen from './screens/AddStickersScreen'
import CustomStickerScreen from './screens/CustomStickerScreen'
    ...
    <AppStateProvider>
      <div className="App">
        <Routes>
          ...
          <Route path="/brand-model-selection" element={<BrandModelSelectionScreen />} />
          <Route path="/customize-image" element={<CustomizeImageScreen />} />
          <Route path="/browse-designs" element={<BrowseDesignsScreen />} />
          <Route path="/design-preview" element={<DesignPreviewScreen />} />
          <Route path="/add-stickers" element={<AddStickersScreen />} />
          <Route path="/custom-sticker" element={<CustomStickerScreen />} />
          <Route path="/template-selection" element={<TemplateSelectionScreen />} />
          <Route path="/phone-preview" element={<PhonePreviewScreen useKonvaEditor={true} />} />
          <Route path="/text-input" element={<TextInputScreen />} />
          <Route path="/add-ons" element={<AddOnsScreen />} />
