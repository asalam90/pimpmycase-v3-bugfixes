...
def init_brands():
    ...
    try:
        brands_data = [
            {
                "id": "BR20250111000002",  # Changed from "iphone" - using Chinese brand ID
                "name": "iPhone",
                "display_name": "IPHONE",
                "chinese_brand_id": "BR20250111000002",  # Same as id now
                "frame_color": "#007AFF",
                "button_color": "#007AFF",
                "is_available": True,
                "display_order": 1,
            ...
            {
                "id": "BR020250120000001",  # Changed from "samsung" - using Chinese brand ID
                "name": "Samsung",
                "display_name": "SAMSUNG",
                "chinese_brand_id": "BR020250120000001",  # Same as id now
                "frame_color": "#1D72AA",
                "button_color": "#1D72AA",
                "is_available": True,
                "display_order": 2,
            ...
            },
            {
                ...
                "frame_color": "#4285F4",
                "button_color": "#4285F4",
                "is_available": False,  # Keep disabled
                "display_order": 3,
        ...
        vending_machines_data = [
            {
                ...
                "qr_config": {
                    "base_url": "https://pimpmycase.co.uk",
