...
STYLE_PROMPTS = {
    "retro-remix": {
        "base": """IMPORTANT: Transform the person shown in the provided reference image into a semi-realistic illustrated portrait that fuses modern polish with a nostalgic retro vibe. You MUST use the person from the reference image - keep their facial features, identity, pose, and likeness recognizable.

COMPOSITION  ▸  Keep the subject from the reference image centred and symmetrical in a tight head-and-shoulders crop, facing the camera with direct eye contact. Preserve the person's appearance and pose. Leave subtle margins for the phone-case camera cut-out.

ART STYLE  ▸  Transform the reference photo into a painterly illustration with smooth dimensional shading and gentle vintage grain. Preserve the person's natural human proportions and recognizable features while maintaining a stylised, illustrated finish — do not overly photorealize the face.

LIGHT & COLOUR  ▸  Soft diffused lighting with balanced contrast. Apply a colour palette that complements the SELECTED RETRO STYLE keyword while maintaining the subject's identity.

BACKGROUND & GRAPHICS  ▸  Replace the background with minimal abstract shapes, geometric forms or texture motifs informed by the style keyword. Background must enhance—not overpower—the subject.
...
After following the guidelines above, adapt the illustration of THE PERSON IN THE REFERENCE IMAGE using the style details described below.""",
        "keywords": {
    ...
    "funny-toon": {
        "styles": {
            "Wild and Wacky": """IMPORTANT: Create a caricature transformation of the EXACT person shown in the provided reference image. You MUST keep their identity, facial features, and likeness clearly recognizable.

• Base Image: Use the person from the reference photo as the subject - maintain their facial structure, features, hair, and identity
• Expression & Features: Transform their expression into a gigantic toothy grin, evenly balanced wide sparkling eyes, playfully arched eyebrows, gently exaggerate their nose & ears while keeping them recognizable, add cheerful energy
• Style: Transform into hand-painted digital illustration with warm gouache textures, subtle painterly outlines, crisp magazine-cover lighting
• Composition: Keep the person's pose from the reference, tight head-and-shoulders crop, straight-on pose, flawlessly balanced left/right proportions, bright golden-orange vignette background for pop
• Colors: rich oranges, terracottas, warm browns, soft highlights and shading for believable depth
• Rendering: ultra-detailed 8k quality, smooth brush-stroke blends, clean edges, no photo artifacts, no phone case or borders
• Mood: fun, playful, slightly retro Mad-magazine vibe
• CRITICAL: The person in the output MUST be the same person from the reference image""",
            "Smooth and Funny": """IMPORTANT: Create a cartoon transformation of the EXACT person shown in the provided reference image. You MUST keep their identity and features clearly recognizable.

• Base Image: Use the person from the reference photo - preserve their facial structure, hair, and identity
• Expression & Features: Transform into wide joyful smile with visible teeth, large sparkling eyes, softly arched eyebrows, gently simplified their nose & ears while keeping them recognizable, approachable energy
• Style: Transform into clean 2D digital illustration with smooth vector-style line art, subtle cel shading, soft gradients, professional animation finish
• Composition: Keep the person's pose, tight head-and-shoulders crop on golden-orange vignette backdrop, straight-on pose, perfectly balanced left/right proportions
...
• CRITICAL: The cartoon MUST be of the same person from the reference image"""
        }
    },
    "cover-shoot": {
        "base": """IMPORTANT: Transform the EXACT person shown in the provided reference image into a high-end professional magazine cover shoot. You MUST keep the person's identity, facial features, and likeness clearly recognizable. Apply the following photography and styling elements to THE PERSON FROM THE REFERENCE IMAGE:
